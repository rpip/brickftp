defmodule BrickFTP.Utils do
  @moduledoc """
  Utility functions for BrickFTP
  """
  ...
  @doc "Removes keys with None type values and empty strings"
  def clean_dict(params) do
    for {k, v} <- params, !is_nil(v), into: %{}, do: {k, v}
  end
end
